...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class Policy
    {
        ...
        static int PolicCompType(string strCompType, ObservableCollection<CompType> CompTypeTypeLst)
        {
            ...
            {
                ActionLogger.Logger.WriteImportPolicyLog("PolicCompType Exception ex: " + ex.Message, true);
            }
            return intStatus;
        }
        ...
        {
            ActionLogger.Logger.WriteImportPolicyLog("UpdateBGUserID: process starts with BGUserId: " + BGUserId + " " + "UserCrdentialId:" + UserCrdentialId, true);
            try
            {
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
                ...
                ActionLogger.Logger.WriteImportPolicyLog("UpdateBGUserID: process success with BGUserId: " + BGUserId + " " + "UserCrdentialId:" + UserCrdentialId, true);
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteImportPolicyLog("UpdateBGUserID process Fails with BGUserId: " + BGUserId + " " + "UserCrdentialId:" + UserCrdentialId, true);
            }
        }
        ...
        {
            ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID:  currentUserBGUserId  : " + currentUserBGUserId + ", payeeName: " + payeeName, true);
            string userID = "";
            try
            {
                if (!string.IsNullOrEmpty(currentUserBGUserId))
                {
                    ...
                    if (getBGUserId == null)
                    {
                        ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID: userID is null", true);
                        if (!string.IsNullOrWhiteSpace(payeeName))
                        {
                            ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID: payeename check ", true);
                            ...
                            try
                            {
                                ...
                                if (objUser != null)
                                {
                                    ...
                                    ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID: payeename found ", true);
                                }
                                else
                                {
                                    ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID: payeename NOT found ", true);
                                }
                            }
                            catch (Exception ex)
                            {
                                ActionLogger.Logger.WriteImportPolicyLog("Import Policy exception:  fields  : " + ex.Message, true);
                    ...
                    else
                    {
                        ...
                        ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID: payee found on User ID ", true);
                    }
                }
                else if (!string.IsNullOrWhiteSpace(payeeName))
                {
                    ...
                    try
                    {
                        ...
                        {
                            userID = Convert.ToString(objUser.UserCredentialId);
                            ActionLogger.Logger.WriteImportPolicyLog("Import Policy GetCDUserID: payee found on name ", true);
                        }
                    }
                    catch (Exception ex)
                    {
        ...
        static void AddImportStatusToDB(string policyID, bool isNew, bool isSuccess, string benefitsID)
        {
            try
            {
                ActionLogger.Logger.WriteImportPolicyLog("AddImportStatusToDB request: policyID -  " + policyID + ", isNew - " + isNew + ", isSuccess - " + isSuccess, true);
            ...
            {
                ActionLogger.Logger.WriteImportPolicyLog("Exception AddImportStatusToDB :  PolicyID -  " + policyID + ", ex: " + ex.Message, true);
            }
        }
        ...
        static void UpdatePolicySchedule(Guid ScheduleID, Guid PolicyID, int? advance, PayorIncomingSchedule policyIncomingSchedule)
        {
            ...
            {
                ActionLogger.Logger.WriteImportPolicyLog("Exception UpdatePolicySchedule :  PolicyID -  " + PolicyID + ", ex: " + ex.Message, true);
            }
        }
        ...
        /// <returns></returns>
        static void GetIncomingScheduleDetail(bool isOldIncomingPresent, PayorIncomingSchedule inSchedule, Guid settingsID, Guid policyID,DateTime? effective,bool IsCustomOutgoing, DateTime? customDate, out double? firstYrIncoming, out double? renewalYrIncoming)
        {
        ...
        {
            ActionLogger.Logger.WriteImportPolicyLog("ValidateOutgoingScheduleOnImport OutGoingField - " + OutGoingField.ToStringDump() + ", LicID: " + LicID, true);
            ActionLogger.Logger.WriteImportPolicyLog("ValidateOutgoingScheduleOnImport IsCustomDate - " + IsCustomDate + ", IsTieredSchedule: " + IsTieredSchedule + ", effective: " + Effective, true);
            string result = "";
            ...
            {
                ActionLogger.Logger.WriteImportPolicyLog("CheckValidIncomingModeForOutgoing false, returning - " + result, true);
                return result;
            }
            ...
            if (Effective == null)
            {
                ...
                ActionLogger.Logger.WriteImportPolicyLog("ValidateOutgoingScheduleOnImport effective date null returning ", true);
                return result;
            }
            ...
            if (!IsCustomDateSelected && OutGoingField != null && OutGoingField.Count != 0)
            {
                ...
                if ((OutGoingField.FirstOrDefault().ScheduleTypeId == 2))
                {
                    ...
                    {
                        OutGoingField = CompleteOutgoingSchedule(OutGoingField, policyID, houseAcct, IsTiered, isTier2Present, false);
                    }
                ...
                else
                {
                    ...
                    GetIncomingScheduleDetail(isOldIncomingPresent, inSchedule, settingsID, policyID,Effective,false, null, out firstYrIncoming, out renewalYrIncoming);
            ...
            else if (IsCustomDateSelected && (OutGoingField != null && OutGoingField.Count != 0))
            {
                try
                {
                    ...
                    if ((OutGoingField.FirstOrDefault().ScheduleTypeId == 2))
                    {
                        foreach (var i in sdates)
                        {
                            ...
                            if (lstOnDate.Count > 0)
                            {
                                ...
                                {
                                    CompleteOutgoingSchedule(OutGoingField, policyID, houseAcct, IsTiered, isTier2Present, true, i.CustomStartDate, lstOnDate[0].CustomEndDate); //assuming end date will be saem against all start dates
                                }
                            }
                            else
                            {
                                ActionLogger.Logger.WriteImportPolicyLog("Custom Schedule found with no payee data for date: " + i, true);
                            }
                        }
                    }
                    else // if (OutPercentOfPremium) //equal incoming when % of premium
                    {
                        foreach (var i in sdates)
                        {
                            ...
                            double? expectedfirst = 0; // SelectedPolicyToolIncommingShedule.FirstYearPercentage;
                            double? expectedRenewal = 0; // SelectedPolicyToolIncommingShedule.RenewalPercentage;

                            GetIncomingScheduleDetail(isOldIncomingPresent, inSchedule, settingsID, policyID,Effective,true, i.CustomStartDate, out expectedfirst, out expectedRenewal);
                ...
                {
                    ActionLogger.Logger.WriteImportPolicyLog("exception validating save policy: " + ex.Message, true);
                }
            }
        ...
        static List<OutGoingPayment> CompleteOutgoingSchedule(List<OutGoingPayment> OutGoingPayments, Guid PolicyID, Guid houseAcct, bool IsTiered, bool isTier2Present, bool isCustom, DateTime? customDate = null, DateTime? customEndDate = null)
        {
            ActionLogger.Logger.WriteImportPolicyLog(" CompleteOutgoingSchedule request:  " + OutGoingPayments.ToStringDump(), true);
            ActionLogger.Logger.WriteImportPolicyLog(" CompleteOutgoingSchedule request: PolicyID - " + PolicyID + ", IsTiered: " + IsTiered + ", istier2present: " + isTier2Present, true);
            ...
            try
            {
                if (OutGoingField != null && OutGoingField.Count > 0)
                {
                    if ((OutGoingField.FirstOrDefault().ScheduleTypeId == 2))
                    {
                        ...
                        if ((!isCustom && (dbFirstYear < 100) || (dbRenewal < 100)) || (isCustom && split < 100))
                        {
                            OutGoingPayment OutgoingRecord = new OutGoingPayment();
                            OutgoingRecord.OutgoingScheduleId = Guid.NewGuid();
                            OutgoingRecord.PolicyId = PolicyID;
                            ...
                            if (!isCustom)
                            {
                                OutgoingRecord.FirstYearPercentage = Convert.ToDouble(100 - dbFirstYear);
                                OutgoingRecord.RenewalPercentage = Convert.ToDouble(100 - dbRenewal);
                            }
                            else
                            {
                                OutgoingRecord.SplitPercent = Convert.ToDouble(100 - split);
            ...
            {
                ActionLogger.Logger.WriteImportPolicyLog("Exception CompleteOutgoingSchedule :  " + ex.Message, true);
            }
        ...
        public static DateTime? GetPolicyTrackFromDate(Guid PolicyID)
        {
            try
            {
                ActionLogger.Logger.WriteImportPolicyLog("GetPolicyTrackFromDate policyID" + PolicyID, true);
                using (SqlConnection con = new SqlConnection(DBConnection.GetConnectionString()))
                {
                    using (SqlCommand cmd = new SqlCommand("Select TrackFromDate from policies where policyID ='" + PolicyID + "'", con))
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            ActionLogger.Logger.WriteImportPolicyLog("GetPolicyTrackFromDate date found: " + dtTime, true);
                            return dtTime;
                        }
                        else
                        {
                            ActionLogger.Logger.WriteImportPolicyLog("GetPolicyTrackFromDate date not found: ", true);
                        }
                    }
                }
            }
            ...
            {
                ActionLogger.Logger.WriteImportPolicyLog("GetPolicyTrackFromDate exception: " + ex.Message, true);
            }
            return null;
        }
        ...
        public static PolicyDetailsData GetPolicyDetailsOnPolicyID(Guid policyID)
        {
            ...
            using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
            {
                ...
                {
                    ActionLogger.Logger.WriteImportPolicyLog("GetPolicyDetailsOnPolicyID " + ex.StackTrace.ToString(), true);
                    ActionLogger.Logger.WriteImportPolicyLog("GetPolicyDetailsOnPolicyID " + ex.InnerException.ToString(), true);
                }
                return policies;
            }
        }
