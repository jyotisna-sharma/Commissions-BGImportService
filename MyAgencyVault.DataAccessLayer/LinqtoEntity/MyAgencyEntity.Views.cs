...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets475A69D5037809C5B601B7DE1818B42161891BA0B60176186360DB9D1E93CDD3))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets475A69D5037809C5B601B7DE1818B42161891BA0B60176186360DB9D1E93CDD3 : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets475A69D5037809C5B601B7DE1818B42161891BA0B60176186360DB9D1E93CDD3()
        {
            this.EdmEntityContainerName = "CommissionDepartmentEntities";
            this.StoreEntityContainerName = "ModelStoreContainer";
            this.HashOverMappingClosure = "400853b002c325a012d22abca1388d0ba7f26a4d7969e36cddb0545633c91087";
            this.HashOverAllExtentViews = "6ad097d869e236b0c1d66cc3827b0e31069cf81f6a6a7af612070e39bf178b09";
            this.ViewCount = 242;
        }
    ...
    SELECT VALUE -- Constructing Carriers
        [Model.Store.Carriers](T1.Carriers_CarrierId, T1.Carriers_CarrierName, T1.Carriers_IsDeleted, T1.Carriers_IsGlobal, T1.Carriers_CreatedBy, T1.Carriers_LicenseeId)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Clients
        [Model.Store.Clients](T1.Clients_ClientId, T1.Clients_LicenseeId, T1.Clients_Name, T1.Clients_Address, T1.Clients_Zip, T1.Clients_City, T1.Clients_State, T1.Clients_Email, T1.Clients_IsDeleted)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Coverages
        [Model.Store.Coverages](T1.Coverages_CoverageId, T1.Coverages_ProductName, T1.Coverages_IsDeleted, T1.Coverages_IsGlobal, T1.Coverages_CreatedBy, T1.Coverages_LicenseeId)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Payors
        [Model.Store.Payors](T1.Payors_PayorId, T1.Payors_PayorName, T1.Payors_PayorRegionId, T1.Payors_PayorTypeId, T1.Payors_PayorStatusId, T1.Payors_IsDeleted, T1.Payors_IsGlobal, T1.Payors_SourceID, T1.Payors_CreatedBy, T1.Payors_NickName, T1.Payors_LicenseeId)
    FROM (
        SELECT 
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView52()
        {
            ...
            viewString.Append("tusId AS Policies_PolicyStatusId, \r\n            T.PolicyType AS Policies_PolicyT");
            viewString.Append("ype, \r\n            T.PolicyClientId AS Policies_PolicyClientId, \r\n            T.");
            viewString.Append("PolicyLicenseeId AS Policies_PolicyLicenseeId, \r\n            T.OriginalEffective");
            viewString.Append("Date AS Policies_OriginalEffectiveDate, \r\n            T.TrackFromDate AS Policie");
            viewString.Append("s_TrackFromDate, \r\n            T.PolicyModeId AS Policies_PolicyModeId, \r\n      ");
            viewString.Append("      T.MonthlyPremium AS Policies_MonthlyPremium, \r\n            T.CoverageId AS");
            viewString.Append(" Policies_CoverageId, \r\n            T.SubmittedThrough AS Policies_SubmittedThro");
            viewString.Append("ugh, \r\n            T.Enrolled AS Policies_Enrolled, \r\n            T.Eligible AS ");
            viewString.Append("Policies_Eligible, \r\n            T.PolicyTerminationDate AS Policies_PolicyTermi");
            viewString.Append("nationDate, \r\n            T.TerminationReasonId AS Policies_TerminationReasonId,");
            viewString.Append(" \r\n            T.IsTrackMissingMonth AS Policies_IsTrackMissingMonth, \r\n        ");
            viewString.Append("    T.IsTrackIncomingPercentage AS Policies_IsTrackIncomingPercentage, \r\n       ");
            viewString.Append("     T.IsTrackPayment AS Policies_IsTrackPayment, \r\n            T.IncomingPaymen");
            viewString.Append("tTypeId AS Policies_IncomingPaymentTypeId, \r\n            T.IsDeleted AS Policies");
            viewString.Append("_IsDeleted, \r\n            T.ReplacedBy AS Policies_ReplacedBy, \r\n            T.P");
            viewString.Append("ayorId AS Policies_PayorId, \r\n            T.DuplicateFrom AS Policies_DuplicateF");
            viewString.Append("rom, \r\n            T.CreatedBy AS Policies_CreatedBy, \r\n            T.CreatedOn ");
            viewString.Append("AS Policies_CreatedOn, \r\n            T.IsIncomingBasicSchedule AS Policies_IsInc");
            viewString.Append("omingBasicSchedule, \r\n            T.IsOutGoingBasicSchedule AS Policies_IsOutGoi");
            viewString.Append("ngBasicSchedule, \r\n            T.CarrierId AS Policies_CarrierId, \r\n            ");
            viewString.Append("T.SplitPercentage AS Policies_SplitPercentage, \r\n            T.Insured AS Polici");
            viewString.Append("es_Insured, \r\n            T.ActivatedOn AS Policies_ActivatedOn, \r\n            T");
            viewString.Append(".IsLocked AS Policies_IsLocked, \r\n            T.LastFollowUpRuns AS Policies_Las");
            viewString.Append("tFollowUpRuns, \r\n            T.RowVersion AS Policies_RowVersion, \r\n            ");
            viewString.Append("T.Advance AS Policies_Advance, \r\n            T.ProductType AS Policies_ProductTy");
            viewString.Append("pe, \r\n            T.UserCredentialId AS Policies_UserCredentialId, \r\n           ");
            viewString.Append(" T.AccoutExec AS Policies_AccoutExec, \r\n            T.LastNoVarIssueDate AS Poli");
            viewString.Append("cies_LastNoVarIssueDate, \r\n            T.LastNoMissIssueDate AS Policies_LastNoM");
            viewString.Append("issIssueDate, \r\n            True AS _from0\r\n        FROM CommissionDepartmentEnt");
            viewString.Append("ities.Policies AS T\r\n    ) AS T1");
    ...
    SELECT VALUE -- Constructing PolicyOutgoingSchedules
        [Model.Store.PolicyOutgoingSchedules](T1.PolicyOutgoingSchedules_OutgoingScheduleId, T1.PolicyOutgoingSchedules_PolicyId, T1.PolicyOutgoingSchedules_PayeeUserCredentialId, T1.PolicyOutgoingSchedules_IsPrimaryAgent, T1.PolicyOutgoingSchedules_FirstYearPercentage, T1.PolicyOutgoingSchedules_RenewalPercentage, T1.PolicyOutgoingSchedules_CreatedOn, T1.PolicyOutgoingSchedules_ScheduleTypeId)
    FROM (
        SELECT 
            T.OutgoingScheduleId AS PolicyOutgoingSchedules_OutgoingScheduleId, 
            T.PolicyId AS PolicyOutgoingSchedules_PolicyId, 
            T.PayeeUserCredentialId AS PolicyOutgoingSchedules_PayeeUserCredentialId, 
            ...
            T.ScheduleTypeId AS PolicyOutgoingSchedules_ScheduleTypeId, 
            True AS _from0
        FROM CommissionDepartmentEntities.PolicyOutgoingSchedules AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing Carriers
        [Model.Carrier](T1.Carrier_CarrierId, T1.Carrier_CarrierName, T1.Carrier_IsDeleted, T1.Carrier_IsGlobal, T1.Carrier_CreatedBy, T1.Carrier_LicenseeId)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Clients
        [Model.Client](T1.Client_ClientId, T1.Client_LicenseeId, T1.Client_Name, T1.Client_Address, T1.Client_Zip, T1.Client_City, T1.Client_State, T1.Client_Email, T1.Client_IsDeleted)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Coverages
        [Model.Coverage](T1.Coverage_CoverageId, T1.Coverage_ProductName, T1.Coverage_IsDeleted, T1.Coverage_IsGlobal, T1.Coverage_CreatedBy, T1.Coverage_LicenseeId)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing Payors
        [Model.Payor](T1.Payor_PayorId, T1.Payor_PayorName, T1.Payor_PayorRegionId, T1.Payor_PayorTypeId, T1.Payor_PayorStatusId, T1.Payor_IsDeleted, T1.Payor_IsGlobal, T1.Payor_SourceID, T1.Payor_CreatedBy, T1.Payor_NickName, T1.Payor_LicenseeId)
    FROM (
        SELECT 
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(3531);
            ...
            viewString.Append("y_AccoutExec, T1.Policy_LastNoMissIssueDate, T1.Policy_LastNoVarIssueDate)\r\n    ");
            viewString.Append("FROM (\r\n        SELECT \r\n            T.PolicyId AS Policy_PolicyId, \r\n          ");
            viewString.Append("  T.PolicyNumber AS Policy_PolicyNumber, \r\n            T.PolicyStatusId AS Polic");
            viewString.Append("y_PolicyStatusId, \r\n            T.PolicyType AS Policy_PolicyType, \r\n           ");
            viewString.Append(" T.PolicyClientId AS Policy_PolicyClientId, \r\n            T.PolicyLicenseeId AS ");
            viewString.Append("Policy_PolicyLicenseeId, \r\n            T.OriginalEffectiveDate AS Policy_Origina");
            viewString.Append("lEffectiveDate, \r\n            T.TrackFromDate AS Policy_TrackFromDate, \r\n       ");
            viewString.Append("     T.PolicyModeId AS Policy_PolicyModeId, \r\n            T.MonthlyPremium AS Po");
            viewString.Append("licy_MonthlyPremium, \r\n            T.CoverageId AS Policy_CoverageId, \r\n        ");
            viewString.Append("    T.SubmittedThrough AS Policy_SubmittedThrough, \r\n            T.Enrolled AS P");
            viewString.Append("olicy_Enrolled, \r\n            T.Eligible AS Policy_Eligible, \r\n            T.Pol");
            viewString.Append("icyTerminationDate AS Policy_PolicyTerminationDate, \r\n            T.TerminationR");
            viewString.Append("easonId AS Policy_TerminationReasonId, \r\n            T.IsTrackMissingMonth AS Po");
            viewString.Append("licy_IsTrackMissingMonth, \r\n            T.IsTrackIncomingPercentage AS Policy_Is");
            viewString.Append("TrackIncomingPercentage, \r\n            T.IsTrackPayment AS Policy_IsTrackPayment");
            viewString.Append(", \r\n            T.IncomingPaymentTypeId AS Policy_IncomingPaymentTypeId, \r\n     ");
            viewString.Append("       T.IsDeleted AS Policy_IsDeleted, \r\n            T.ReplacedBy AS Policy_Rep");
            viewString.Append("lacedBy, \r\n            T.PayorId AS Policy_PayorId, \r\n            T.DuplicateFro");
            viewString.Append("m AS Policy_DuplicateFrom, \r\n            T.CreatedBy AS Policy_CreatedBy, \r\n    ");
            viewString.Append("        T.CreatedOn AS Policy_CreatedOn, \r\n            T.IsIncomingBasicSchedule");
            viewString.Append(" AS Policy_IsIncomingBasicSchedule, \r\n            T.IsOutGoingBasicSchedule AS P");
            viewString.Append("olicy_IsOutGoingBasicSchedule, \r\n            T.CarrierId AS Policy_CarrierId, \r\n");
            viewString.Append("            T.SplitPercentage AS Policy_SplitPercentage, \r\n            T.Insured");
            viewString.Append(" AS Policy_Insured, \r\n            T.ActivatedOn AS Policy_ActivatedOn, \r\n       ");
            viewString.Append("     T.IsLocked AS Policy_IsLocked, \r\n            T.LastFollowUpRuns AS Policy_L");
            ...
            viewString.Append("outExec AS Policy_AccoutExec, \r\n            T.LastNoMissIssueDate AS Policy_Last");
            viewString.Append("NoMissIssueDate, \r\n            T.LastNoVarIssueDate AS Policy_LastNoVarIssueDate");
    ...
    SELECT VALUE -- Constructing PolicyOutgoingSchedules
        [Model.PolicyOutgoingSchedule](T1.PolicyOutgoingSchedule_OutgoingScheduleId, T1.PolicyOutgoingSchedule_PolicyId, T1.PolicyOutgoingSchedule_PayeeUserCredentialId, T1.PolicyOutgoingSchedule_IsPrimaryAgent, T1.PolicyOutgoingSchedule_FirstYearPercentage, T1.PolicyOutgoingSchedule_RenewalPercentage, T1.PolicyOutgoingSchedule_CreatedOn, T1.PolicyOutgoingSchedule_ScheduleTypeId)
    FROM (
        SELECT 
            T.OutgoingScheduleId AS PolicyOutgoingSchedule_OutgoingScheduleId, 
            T.PolicyId AS PolicyOutgoingSchedule_PolicyId, 
            T.PayeeUserCredentialId AS PolicyOutgoingSchedule_PayeeUserCredentialId, 
            T.IsPrimaryAgent AS PolicyOutgoingSchedule_IsPrimaryAgent, 
            T.FirstYearPercentage AS PolicyOutgoingSchedule_FirstYearPercentage, 
            T.RenewalPercentage AS PolicyOutgoingSchedule_RenewalPercentage, 
            T.CreatedOn AS PolicyOutgoingSchedule_CreatedOn, 
            T.ScheduleTypeId AS PolicyOutgoingSchedule_ScheduleTypeId, 
            True AS _from0
        FROM ModelStoreContainer.PolicyOutgoingSchedules AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing CoverageNickNames
        [Model.CoverageNickName](T1.CoverageNickName_CoverageNickID, T1.CoverageNickName_PayorId, T1.CoverageNickName_CarrierId, T1.CoverageNickName_CoverageId, T1.CoverageNickName_NickName, T1.CoverageNickName_CreatedBy, T1.CoverageNickName_ModifiedBy, T1.CoverageNickName_ModifiedOn, T1.CoverageNickName_IsDeleted)
    FROM (
        SELECT 
            T.CoverageNickID AS CoverageNickName_CoverageNickID, 
            T.PayorId AS CoverageNickName_PayorId, 
    ...
    SELECT VALUE -- Constructing MasterReportList
        [Model.Store.MasterReportList](T1.MasterReportList_ReportId, T1.MasterReportList_ReportCode, T1.MasterReportList_ReportName, T1.MasterReportList_ReportGroupName, T1.MasterReportList_ReportDescription)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing PayeeStatementReports
        [Model.PayeeStatementReport](T1.PayeeStatementReport_ReportId, T1.PayeeStatementReport_LicenceID, T1.PayeeStatementReport_Batch, T1.PayeeStatementReport_Payee, T1.PayeeStatementReport_Reports, T1.PayeeStatementReport_PaymentType, T1.PayeeStatementReport_ReportOn, T1.PayeeStatementReport_Zero, T1.PayeeStatementReport_IsSplit, T1.PayeeStatementReport_IsPayorRate)
    FROM (
        SELECT 
