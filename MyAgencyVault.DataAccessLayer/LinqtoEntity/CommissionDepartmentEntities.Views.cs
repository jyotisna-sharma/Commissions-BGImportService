...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsD8D9F5EF2E23C96CD6C95CD2ABDD3DA51B518CFC32CA42DE4B0C0817FA078A36))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySetsD8D9F5EF2E23C96CD6C95CD2ABDD3DA51B518CFC32CA42DE4B0C0817FA078A36 : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySetsD8D9F5EF2E23C96CD6C95CD2ABDD3DA51B518CFC32CA42DE4B0C0817FA078A36()
        {
            this.EdmEntityContainerName = "CommissionDepartmentEntities";
            this.StoreEntityContainerName = "ModelStoreContainer";
            this.HashOverMappingClosure = "2ff796b06c1c0091d05fb93be569080099f28c123e4e44a316f14c1a0901bd12";
            this.HashOverAllExtentViews = "c82b776bec7cecc3a4148b4786f093d0cf53b5259d5a026fe28955ecad3938aa";
            this.ViewCount = 286;
        }
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(3708);
            ...
            viewString.Append("edFields_ImportPolicyID, T1.[PolicyLearnedFields.BG_PolicyPlanID])\r\n    FROM (\r\n");
            viewString.Append("        SELECT \r\n            T.PolicyId AS PolicyLearnedFields_PolicyId, \r\n     ");
            viewString.Append("       T.Insured AS PolicyLearnedFields_Insured, \r\n            T.PolicyNumber AS");
            viewString.Append(" PolicyLearnedFields_PolicyNumber, \r\n            T.Effective AS PolicyLearnedFie");
            viewString.Append("lds_Effective, \r\n            T.TrackFrom AS PolicyLearnedFields_TrackFrom, \r\n   ");
            viewString.Append("         T.PAC AS PolicyLearnedFields_PAC, \r\n            T.PMC AS PolicyLearnedF");
            viewString.Append("ields_PMC, \r\n            T.ModalAvgPremium AS PolicyLearnedFields_ModalAvgPremiu");
            viewString.Append("m, \r\n            T.PolicyModeId AS PolicyLearnedFields_PolicyModeId, \r\n         ");
            viewString.Append("   T.Enrolled AS PolicyLearnedFields_Enrolled, \r\n            T.Eligible AS Polic");
            viewString.Append("yLearnedFields_Eligible, \r\n            T.AutoTerminationDate AS PolicyLearnedFie");
            viewString.Append("lds_AutoTerminationDate, \r\n            T.Link1 AS PolicyLearnedFields_Link1, \r\n ");
            viewString.Append("           T.LastModifiedOn AS PolicyLearnedFields_LastModifiedOn, \r\n           ");
            viewString.Append(" T.LastModifiedUserCredentialid AS PolicyLearnedFields_LastModifiedUserCredentia");
            viewString.Append("lid, \r\n            T.ClientID AS PolicyLearnedFields_ClientID, \r\n            T.C");
            viewString.Append("ompTypeID AS PolicyLearnedFields_CompTypeID, \r\n            T.PayorSysID AS Polic");
            viewString.Append("yLearnedFields_PayorSysID, \r\n            T.Renewal AS PolicyLearnedFields_Renewa");
            viewString.Append("l, \r\n            T.SplitPercentage AS PolicyLearnedFields_SplitPercentage, \r\n   ");
            viewString.Append("         T.CompScheduleType AS PolicyLearnedFields_CompScheduleType, \r\n         ");
            viewString.Append("   T.CarrierId AS PolicyLearnedFields_CarrierId, \r\n            T.CoverageId AS P");
            viewString.Append("olicyLearnedFields_CoverageId, \r\n            T.PayorId AS PolicyLearnedFields_Pa");
            viewString.Append("yorId, \r\n            T.PreviousEffectiveDate AS PolicyLearnedFields_PreviousEffe");
            viewString.Append("ctiveDate, \r\n            T.PreviousPolicyModeId AS PolicyLearnedFields_PreviousP");
            viewString.Append("olicyModeId, \r\n            T.CarrierNickName AS PolicyLearnedFields_CarrierNickN");
            viewString.Append("ame, \r\n            T.CoverageNickName AS PolicyLearnedFields_CoverageNickName, \r");
            viewString.Append("\n            T.Advance AS PolicyLearnedFields_Advance, \r\n            T.ProductTy");
            viewString.Append("pe AS PolicyLearnedFields_ProductType, \r\n            T.UserCredentialId AS Polic");
            viewString.Append("yLearnedFields_UserCredentialId, \r\n            T.AccoutExec AS PolicyLearnedFiel");
            viewString.Append("ds_AccoutExec, \r\n            T.ImportPolicyID AS PolicyLearnedFields_ImportPolic");
            viewString.Append("yID, \r\n            T.BG_PolicyPlanID AS [PolicyLearnedFields.BG_PolicyPlanID], \r");
            viewString.Append("\n            True AS _from0\r\n        FROM CommissionDepartmentEntities.PolicyLea");
            viewString.Append("rnedFields AS T\r\n    ) AS T1");
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView125()
        {
            ...
            viewString.Append("cyLearnedField_AccoutExec, T1.PolicyLearnedField_ImportPolicyID, T1.[PolicyLearn");
            viewString.Append("edField.BG_PolicyPlanID])\r\n    FROM (\r\n        SELECT \r\n            T.PolicyId A");
            viewString.Append("S PolicyLearnedField_PolicyId, \r\n            T.Insured AS PolicyLearnedField_Ins");
            viewString.Append("ured, \r\n            T.PolicyNumber AS PolicyLearnedField_PolicyNumber, \r\n       ");
            viewString.Append("     T.Effective AS PolicyLearnedField_Effective, \r\n            T.TrackFrom AS P");
            viewString.Append("olicyLearnedField_TrackFrom, \r\n            T.PAC AS PolicyLearnedField_PAC, \r\n  ");
            viewString.Append("          T.PMC AS PolicyLearnedField_PMC, \r\n            T.ModalAvgPremium AS Po");
            viewString.Append("licyLearnedField_ModalAvgPremium, \r\n            T.PolicyModeId AS PolicyLearnedF");
            viewString.Append("ield_PolicyModeId, \r\n            T.Enrolled AS PolicyLearnedField_Enrolled, \r\n  ");
            viewString.Append("          T.Eligible AS PolicyLearnedField_Eligible, \r\n            T.AutoTermina");
            viewString.Append("tionDate AS PolicyLearnedField_AutoTerminationDate, \r\n            T.Link1 AS Pol");
            viewString.Append("icyLearnedField_Link1, \r\n            T.LastModifiedOn AS PolicyLearnedField_Last");
            viewString.Append("ModifiedOn, \r\n            T.LastModifiedUserCredentialid AS PolicyLearnedField_L");
            viewString.Append("astModifiedUserCredentialid, \r\n            T.ClientID AS PolicyLearnedField_Clie");
            viewString.Append("ntID, \r\n            T.CompTypeID AS PolicyLearnedField_CompTypeID, \r\n           ");
            viewString.Append(" T.PayorSysID AS PolicyLearnedField_PayorSysID, \r\n            T.Renewal AS Polic");
            viewString.Append("yLearnedField_Renewal, \r\n            T.SplitPercentage AS PolicyLearnedField_Spl");
            viewString.Append("itPercentage, \r\n            T.CompScheduleType AS PolicyLearnedField_CompSchedul");
            viewString.Append("eType, \r\n            T.CarrierId AS PolicyLearnedField_CarrierId, \r\n            ");
            viewString.Append("T.CoverageId AS PolicyLearnedField_CoverageId, \r\n            T.PayorId AS Policy");
            viewString.Append("LearnedField_PayorId, \r\n            T.PreviousEffectiveDate AS PolicyLearnedFiel");
            viewString.Append("d_PreviousEffectiveDate, \r\n            T.PreviousPolicyModeId AS PolicyLearnedFi");
            viewString.Append("eld_PreviousPolicyModeId, \r\n            T.CarrierNickName AS PolicyLearnedField_");
            viewString.Append("CarrierNickName, \r\n            T.CoverageNickName AS PolicyLearnedField_Coverage");
            viewString.Append("NickName, \r\n            T.Advance AS PolicyLearnedField_Advance, \r\n            T");
            viewString.Append(".ProductType AS PolicyLearnedField_ProductType, \r\n            T.UserCredentialId");
            viewString.Append(" AS PolicyLearnedField_UserCredentialId, \r\n            T.AccoutExec AS PolicyLea");
            viewString.Append("rnedField_AccoutExec, \r\n            T.ImportPolicyID AS PolicyLearnedField_Impor");
            viewString.Append("tPolicyID, \r\n            T.BG_PolicyPlanID AS [PolicyLearnedField.BG_PolicyPlanI");
            viewString.Append("D], \r\n            True AS _from0\r\n        FROM ModelStoreContainer.PolicyLearned");
            viewString.Append("Fields AS T\r\n    ) AS T1");
